...
export function SiteHeader() {
  ...
  return (
    <header className="border-b border-slate-800 bg-ink/85 backdrop-blur-xl sticky top-0 z-50 safe-top shadow-[0_1px_0_0_rgba(201,162,92,0.08)]">
      {/* Top Bar */}
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <div className="relative" ref={resourcesRef}>
              ...
              {resourcesOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 glass-card-elevated rounded-xl shadow-xl py-2 z-50">
