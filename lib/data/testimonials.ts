...
export const testimonials: Testimonial[] = [
  {
    ...
    location: 'Tupelo, MS',
    rating: 5,
    text: "After that bad storm came through Lee County last spring, I needed my roof looked at fast. Farrell Roofing had someone out the next day. The estimate was fair and they worked with my insurance company the whole way. Roof looks better than new and it's already been through two more storms without a single issue.",
  ...
  },
  {
    ...
    rating: 5,
    text: "First-time homeowner here and I had no idea what a roof should cost. This tool gave me a realistic range so I wasn't going in blind. Farrell's crew did quality work and finished a day early. They even noticed some ventilation issues I didn't know about and fixed those too. Highly recommend to anyone in the Starkville area.",
    projectType: 'Full Roof Replacement',
    date: '2025-10-12',
  },
  {
    ...
    rating: 5,
    text: "Hail tore up our roof something awful last spring. Farrell Roofing handled the whole insurance claim process for us. They documented everything, met with the adjuster, and made sure we got what we were owed. The new impact-resistant shingles they installed have held up great through multiple storms since then.",
  ...
  },
  {
    ...
    rating: 5,
    text: "These folks are the real deal. Been burned by storm chasers before, but Farrell Roofing is different - local, licensed, and they stand behind their work. They caught some deck damage that other roofers missed. The warranty they provide gives us real peace of mind.",
    projectType: 'Roof Replacement',
    date: '2025-06-05',
  },
]
