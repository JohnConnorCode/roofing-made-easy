-- Migration 053: Seed existing static blog posts
-- Inserts the 14 hand-written blog posts that were previously hardcoded in lib/data/blog.ts

-- Post 1: 7 Warning Signs You Need a New Roof in Mississippi
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'signs-you-need-new-roof',
  '7 Warning Signs You Need a New Roof in Mississippi',
  'Mississippi''s humid subtropical climate puts unique stress on roofing systems. Learn the early warning signs that indicate your roof may need replacement before water damage occurs.',
  $bp1$# 7 Warning Signs You Need a New Roof in Mississippi
...
[Schedule Your Free Roof Inspection](/services/roof-inspection) today to understand your roof's true condition.$bp1$,
  'Maintenance',
  'Mike Farrell',
  8,
  true,
  ARRAY['roof replacement', 'maintenance', 'inspection', 'mississippi roofing'],
  '/images/blog/roof-warning-signs.jpg',
  'published',
  '2026-01-20T00:00:00Z'
);

-- Post 2: Asphalt vs. Metal Roofing in Mississippi: Complete Cost & Performance Comparison
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'asphalt-vs-metal-roofing',
  'Asphalt vs. Metal Roofing in Mississippi: Complete Cost & Performance Comparison',
  'Choosing between asphalt shingles and metal roofing for your Mississippi home? This comprehensive guide compares costs, durability, energy efficiency, and storm resistance to help you decide.',
  $bp2$# Asphalt vs. Metal Roofing in Mississippi: Complete Cost & Performance Comparison
...
[Get Your Free Roofing Estimate](/) today to compare options for your specific home.$bp2$,
  'Materials',
  'Mike Farrell',
  12,
  true,
  ARRAY['metal roofing', 'asphalt shingles', 'comparison', 'mississippi', 'roofing materials'],
  '/images/blog/metal-vs-asphalt.jpg',
  'published',
  '2026-01-15T00:00:00Z'
);

-- Post 3: Complete Roof Maintenance Checklist for Mississippi Homeowners
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'roof-maintenance-checklist',
  'Complete Roof Maintenance Checklist for Mississippi Homeowners',
  'A seasonal maintenance guide designed specifically for Mississippi''s climate. Learn what to check each season to extend your roof''s lifespan and prevent costly damage.',
  $bp3$# Complete Roof Maintenance Checklist for Mississippi Homeowners
...
[Schedule a Maintenance Inspection](/) with Smart Roof Pricing. We'll assess your roof's current condition and recommend a maintenance schedule tailored to your specific roof type and age.$bp3$,
  'Maintenance',
  'Lisa Farrell',
  10,
  false,
  ARRAY['maintenance', 'checklist', 'seasonal', 'mississippi', 'roof care'],
  '/images/blog/roof-maintenance.jpg',
  'published',
  '2026-01-08T00:00:00Z'
);

-- Post 4: Mississippi Roof Insurance Claims: A Complete Homeowner Guide
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'roof-insurance-claims',
  'Mississippi Roof Insurance Claims: A Complete Homeowner Guide',
  'Navigate the roof insurance claim process confidently with this comprehensive guide for Mississippi homeowners. Includes tips for documentation, working with adjusters, and avoiding claim denials.',
  $bp4$# Mississippi Roof Insurance Claims: Complete Step-by-Step Guide
...
[Schedule Your Free Storm Damage Assessment](/) today.$bp4$,
  'Insurance',
  'Mike Farrell',
  14,
  true,
  ARRAY['insurance', 'storm damage', 'claims', 'mississippi', 'hurricane'],
  '/images/blog/insurance-claims.jpg',
  'published',
  '2025-12-15T00:00:00Z'
);

-- Post 5: How to Choose a Roofing Contractor in Mississippi: The Complete Guide
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'choosing-roofing-contractor',
  'How to Choose a Roofing Contractor in Mississippi: The Complete Guide',
  'Protect yourself from scams and ensure quality workmanship with this comprehensive guide to vetting roofing contractors in Mississippi. Includes red flags, verification steps, and contract essentials.',
  $bp5$# How to Choose a Roofing Contractor in Mississippi: 15 Essential Questions
...
[Request Your Free Estimate](/) from a contractor you can verify and trust.$bp5$,
  'Guides',
  'Mike Farrell',
  12,
  false,
  ARRAY['contractor', 'hiring', 'tips', 'mississippi', 'verification'],
  '/images/blog/choosing-contractor.jpg',
  'published',
  '2025-11-20T00:00:00Z'
);

-- Post 6: How Much Does a New Roof Cost in Mississippi? 2026 Pricing Guide
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'new-roof-cost-mississippi-2026',
  'How Much Does a New Roof Cost in Mississippi? 2026 Pricing Guide',
  'Get real 2026 pricing for a new roof in Mississippi. We break down costs by material, roof size, and complexity so you can budget confidently for your roof replacement.',
  $bp6$# How Much Does a New Roof Cost in Mississippi? (2026 Guide)
...
[Get Your Free Roof Estimate](/) today, or call us to discuss your project. We serve [Tupelo](/tupelo-roofing), [Oxford](/oxford-roofing), [Starkville](/starkville-roofing), and communities throughout Northeast Mississippi.$bp6$,
  'Pricing',
  'Mike Farrell',
  12,
  true,
  ARRAY['roof cost', 'pricing', 'mississippi', 'roof replacement', '2026'],
  '/images/blog/new-roof-cost-2026.jpg',
  'published',
  '2026-02-10T00:00:00Z'
);

-- Post 7: Metal Roof vs Shingles: The Real Cost Comparison for Mississippi Homeowners
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'metal-roof-vs-shingles-cost',
  'Metal Roof vs Shingles: The Real Cost Comparison for Mississippi Homeowners',
  'Compare the true 30-year cost of metal roofing vs asphalt shingles in Mississippi. When you factor in replacements, energy savings, insurance discounts, and maintenance, the numbers may surprise you.',
  $bp7$# Metal Roof vs Shingles: The Real Cost Difference Over 30 Years
...
Want more detail on material options? Read our complete [asphalt vs. metal roofing comparison](/blog/asphalt-vs-metal-roofing) for performance details beyond cost.$bp7$,
  'Cost',
  'Mike Farrell',
  10,
  true,
  ARRAY['metal roofing', 'asphalt shingles', 'cost comparison', 'roi', 'mississippi'],
  '/images/blog/metal-vs-shingles-cost.jpg',
  'published',
  '2026-02-05T00:00:00Z'
);

-- Post 8: What Factors Affect Your Roof Replacement Cost? A Mississippi Breakdown
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'roof-replacement-cost-factors',
  'What Factors Affect Your Roof Replacement Cost? A Mississippi Breakdown',
  'From roof size and pitch to material choice and deck condition, learn every factor that influences what you will pay for a new roof. Understand what drives pricing so you can budget accurately.',
  $bp8$# What Factors Affect Your Roof Replacement Cost?
...
Ready to understand exactly what your [roof replacement](/services/roof-replacement) will cost? [Get your free estimate](/) from Smart Roof Pricing. We provide detailed, line-item quotes that explain every cost factor so there are no surprises.$bp8$,
  'Cost',
  'Lisa Farrell',
  8,
  false,
  ARRAY['roof replacement', 'cost factors', 'pricing', 'roof size', 'materials'],
  '/images/blog/cost-factors.jpg',
  'published',
  '2026-01-28T00:00:00Z'
);

-- Post 9: Is a Free Roof Inspection Really Free? What to Expect in Mississippi
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'free-roof-inspection-what-to-expect',
  'Is a Free Roof Inspection Really Free? What to Expect in Mississippi',
  'Wondering what actually happens during a free roof inspection? Learn what inspectors look for, how to prepare, what red flags to watch for, and whether that free inspection truly has no strings attached.',
  $bp9$# Is a Free Roof Inspection Really Free? What to Expect
...
[Schedule Your Free Roof Inspection](/services/roof-inspection) today, or call us with any questions. We serve homeowners throughout Northeast Mississippi.$bp9$,
  'Guides',
  'Mike Farrell',
  7,
  false,
  ARRAY['roof inspection', 'free inspection', 'what to expect', 'mississippi'],
  '/images/blog/free-roof-inspection.jpg',
  'published',
  '2026-01-18T00:00:00Z'
);

-- Post 10: Mississippi Storm Damage: What Your Insurance Covers (and What It Doesn't)
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'mississippi-storm-damage-insurance-coverage',
  'Mississippi Storm Damage: What Your Insurance Covers (and What It Doesn''t)',
  'Understand exactly what your Mississippi homeowner''s insurance covers for storm-related roof damage, including wind, hail, tornado, and hurricane events. Learn about deductibles, ACV vs replacement cost, claims, and common denial reasons.',
  $bp10$# Mississippi Storm Damage: What Your Insurance Covers (and What It Doesn't)
...
[Schedule Your Free Storm Damage Assessment](/) today. Don't wait for the next storm to find out where you stand.$bp10$,
  'Insurance',
  'Mike Farrell',
  10,
  true,
  ARRAY['storm damage', 'insurance', 'mississippi', 'claims', 'hurricane', 'tornado'],
  '/images/blog/storm-damage-insurance.jpg',
  'published',
  '2026-01-12T00:00:00Z'
);

-- Post 11: Best Roofing Materials for Mississippi Climate: A Head-to-Head Comparison
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'best-roofing-materials-mississippi-climate',
  'Best Roofing Materials for Mississippi Climate: A Head-to-Head Comparison',
  'From 3-tab shingles to standing seam metal, every roofing material performs differently in Mississippi''s heat, humidity, and severe storms. Here''s an honest comparison to help you pick the right roof for your home and budget.',
  $bp11$# Best Roofing Materials for Mississippi's Climate: A Complete Comparison
...
If you're not ready for an estimate but want to learn more, check out our detailed comparison of [asphalt vs. metal roofing](/blog/asphalt-vs-metal-roofing) or our breakdown of [roof replacement cost factors](/blog/roof-replacement-cost-factors) in Mississippi.$bp11$,
  'Materials',
  'Mike Farrell',
  12,
  false,
  ARRAY['roofing materials', 'metal roofing', 'asphalt shingles', 'mississippi climate', 'roof comparison'],
  '/images/blog/roofing-materials-comparison.jpg',
  'published',
  '2026-02-15T00:00:00Z'
);

-- Post 12: Mississippi Roof Maintenance Calendar: Your Month-by-Month Checklist
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'mississippi-roof-maintenance-calendar',
  'Mississippi Roof Maintenance Calendar: Your Month-by-Month Checklist',
  'A printable month-by-month schedule for Mississippi homeowners. Know exactly when to inspect, clean, and prep your roof — with time estimates and DIY vs. pro guidance for each task.',
  $bp12$# Mississippi Roof Maintenance Calendar: Month-by-Month Action Plan
...
[Schedule a Professional Roof Inspection](/services/roof-inspection) if you'd rather have an expert handle the assessment.$bp12$,
  'Maintenance',
  'Mike Farrell',
  7,
  false,
  ARRAY['roof maintenance', 'seasonal maintenance', 'mississippi', 'maintenance calendar', 'storm prep'],
  '/images/blog/roof-maintenance-calendar.jpg',
  'published',
  '2026-02-22T00:00:00Z'
);

-- Post 13: How to Finance a New Roof in Mississippi: Every Option Explained
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'roof-financing-options-mississippi',
  'How to Finance a New Roof in Mississippi: Every Option Explained',
  'A new roof is a major expense, but you have more payment options than you might think. This guide covers every financing path available to Mississippi homeowners, from personal loans to government assistance programs.',
  $bp13$# How to Finance a New Roof in Mississippi: Payment Plans, Loans & Assistance Programs
...
For more on what drives roofing costs in Mississippi, read our guide to [new roof costs in Mississippi](/blog/new-roof-cost-mississippi-2026) or [roof replacement cost factors](/blog/roof-replacement-cost-factors).$bp13$,
  'Financing',
  'Mike Farrell',
  11,
  false,
  ARRAY['roof financing', 'payment plans', 'USDA loans', 'mississippi', 'home improvement loans', 'insurance claims'],
  '/images/blog/roof-financing-options.jpg',
  'published',
  '2026-03-01T00:00:00Z'
);

-- Post 14: Hail Damage to Your Mississippi Roof: The Complete Homeowner Guide
INSERT INTO blog_posts (slug, title, excerpt, content, category, author, read_time, featured, tags, image, status, published_at)
VALUES (
  'hail-damage-roof-mississippi-guide',
  'Hail Damage to Your Mississippi Roof: The Complete Homeowner Guide',
  'Hail damage isn''t always obvious from the ground, but it can shorten your roof''s life by years. Learn how to identify hail damage on different roofing materials, document it properly, and navigate the insurance claim process.',
  $bp14$# Hail Damage to Your Mississippi Roof: How to Spot It, Document It & File a Claim
...
For a comprehensive look at what your insurance covers, read our [Mississippi storm damage insurance guide](/blog/mississippi-storm-damage-insurance-coverage) and [insurance claims guide](/blog/roof-insurance-claims).$bp14$,
  'Insurance',
  'Mike Farrell',
  9,
  false,
  ARRAY['hail damage', 'insurance claims', 'mississippi', 'storm damage', 'roof inspection', 'hail'],
  '/images/blog/hail-damage-guide.jpg',
  'published',
